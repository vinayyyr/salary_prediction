...
def load_data():
    ...
    df = df[df["ConvertedCompYearly"] >= 40000]
...
def explore_page():
    ...
    plt.scatter('Salary','Country', color="blue")
    ...
    ax1.axis("equal")  # ensures that pie is drawn as circle.
    ...
    st.write("""#### Salary against Country""")
    st.pyplot(fig)
